    ...
    >
      ...
      >
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          ...
          <p className={`text-[#41cc7b] ${styles.paragraph} ml-2`}>
        ...
        <h1 className="font-poppins font-semibold ss:text-[68px] text-[52px] text-[#b4a3e3] ss:leading-[100.8px] leading-[75px] w-full">
          Get Hired.
        </h1>
